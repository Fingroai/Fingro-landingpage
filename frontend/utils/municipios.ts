/**
 * Lista completa de municipios por departamento en Guatemala
 */
...
export const municipiosPorDepartamento: Record<string, string[]> = {
  ...
  "Huehuetenango": [
    ...
    "San Pedro Necta", "Jacaltenango", "Soloma", "San Ildefonso Ixtahuacán", 
  ...
  "Sacatepéquez": [
    ...
    "Ciudad Vieja", "San Miguel Dueñas", "San Juan Alotenango", "San Antonio Aguas Calientes", "Santa Catarina Barahona"
  ],
  "San Marcos": [
